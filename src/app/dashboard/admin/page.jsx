...
export default function AdminDashboardPage() {
  ...
  const statsSummary = [
    { title: "Total Users", value: "3,520", icon: FiUsers, color: "from-cyan-500/10 to-blue-500/5", text: "text-cyan-400", border: "border-cyan-500/20" },
    { title: "Total Public Lessons", value: "2,412", icon: FiBookOpen, color: "from-emerald-500/10 to-teal-500/5", text: "text-emerald-400", border: "border-emerald-500/20" },
