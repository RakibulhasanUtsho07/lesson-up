...
import { Card, Avatar, Button, Tooltip, Badge, Link } from "@heroui/react";
import { 
  FiSearch, 
  FiTrash2, 
  FiAlertTriangle, 
...
export default function AdminManageLessonsSection({allLessons}) {
    console.log(allLessons, "manage lessons")
          ...
          <table className="w-full min-w-[850px] text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-900/40 text-xs font-medium text-slate-300">
              ...
              {filteredLessons.map((lesson, ind) => {
                ...
                return (
                  <tr key={ind} className={`hover:bg-slate-900/10 transition-colors group ${isReported ? "bg-rose-950/5" : ""}`}>
